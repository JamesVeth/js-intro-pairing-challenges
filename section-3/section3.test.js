...
describe("tripleNums", () => {
  test("returns all numbers in array multipled by three", () => {
    let nums = [1, 2, 3, 4];
...
describe("shoutNames", () => {
  test("returns all names uppercased", () => {
...
describe("isSweetEnough", () => {
  test("returns true when all foods are sweet", () => {
    const foodArray = [
  ...
  test("returns false when no foods are sweet", () => {
    const foodArray = [
  ...
  test("returns false when not all foods are sweet", () => {
    const foodArray = [
...
describe("getExcited", () => {
  test("returns string with all full stops changed to exclamation marks", () => {
...
describe("isShrekCharacter", () => {
  test("returns empty array if no characters are from the movie, Shrek.", () => {
    const characters = [
  ...
  test("returns all characters if all characters are from the movie, Shrek.", () => {
    const characters = [
      {
        name: "Shrek",
        movie: "Shrek",
  ...
  test("returns some characters if some characters are from the movie, Shrek.", () => {
    const characters = [
      {
        name: "Cher",
        movie: "Clueless",
  ...
  test("returns any characters from the Shrek franchise.", () => {
    const characters = [
